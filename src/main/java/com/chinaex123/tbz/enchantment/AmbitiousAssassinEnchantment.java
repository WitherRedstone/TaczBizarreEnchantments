...
public class AmbitiousAssassinEnchantment extends Enchantment {
    ...
    public int getMinCost(int level) {
        return TBZServerConfig.AMBITIOUS_ASSASSIN_BASE_ENCHANTABILITY.get() + (level - 1) * TBZServerConfig.AMBITIOUS_ASSASSIN_LEVEL_ENCHANTABILITY.get();
    }

    /** 最大附魔成本 **/
    @Override
    public int getMaxCost(int level) {
        return this.getMinCost(level) + TBZServerConfig.AMBITIOUS_ASSASSIN_ENCHANTABILITY_SPAN.get();
    }

    /** 最大附魔等级 **/
    @Override
    public int getMaxLevel() {
        return TBZServerConfig.AMBITIOUS_ASSASSIN_MAX_LEVEL.get();
    }
