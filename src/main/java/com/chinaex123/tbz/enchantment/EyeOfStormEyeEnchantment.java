...
public class EyeOfStormEyeEnchantment extends Enchantment {
    ...
    public int getMinCost(int level) {
        return TBZServerConfig.EYE_OF_STORM_EYE_BASE_ENCHANTABILITY.get() + (level - 1) * TBZServerConfig.EYE_OF_STORM_EYE_LEVEL_ENCHANTABILITY.get();
    }

    /** 最大附魔成本 **/
    @Override
    public int getMaxCost(int level) {
        return this.getMinCost(level) + TBZServerConfig.EYE_OF_STORM_EYE_ENCHANTABILITY_SPAN.get();
    }

    /** 最大附魔等级 **/
    @Override
    public int getMaxLevel() {
        return TBZServerConfig.EYE_OF_STORM_EYE_MAX_LEVEL.get();
    }
