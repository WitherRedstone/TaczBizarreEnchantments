...
public class FullStopEnchantment extends Enchantment {
    ...
    public int getMinCost(int level) {
        return TBZServerConfig.FULL_STOP_BASE_ENCHANTABILITY.get() + (level - 1) * TBZServerConfig.FULL_STOP_LEVEL_ENCHANTABILITY.get();
    }

    /** 最大附魔等级 **/
    @Override
    public int getMaxCost(int level) {
        return this.getMinCost(level) + TBZServerConfig.FULL_STOP_ENCHANTABILITY_SPAN.get();
    }

    /** 最大附魔等级 **/
    @Override
    public int getMaxLevel() {
        return TBZServerConfig.FULL_STOP_MAX_LEVEL.get();
    }
