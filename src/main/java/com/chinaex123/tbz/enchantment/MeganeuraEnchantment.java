...
public class MeganeuraEnchantment extends Enchantment {
    ...
    public int getMinCost(int level) {
        return TBZConfig.MEGANEURA_BASE_ENCHANTABILITY.get();
    }

    /** 最大附魔成本 **/
    @Override
    public int getMaxCost(int level) {
        return this.getMinCost(level) + TBZConfig.MEGANEURA_ENCHANTABILITY_SPAN.get();
    }

    /** 最大附魔等级 **/
    @Override
    public int getMaxLevel() {
        return TBZConfig.MEGANEURA_MAX_LEVEL.get();
    }
