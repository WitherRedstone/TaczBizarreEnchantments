...
public class ProtectiveWeaveEnchantment extends Enchantment {
    ...
    public int getMinCost(int level) {
        return TBZServerConfig.PROTECTIVE_WEAVE_BASE_ENCHANTABILITY.get() + (level - 1) * TBZServerConfig.PROTECTIVE_WEAVE_LEVEL_ENCHANTABILITY.get();
    }

    /** 最大附魔成本 **/
    @Override
    public int getMaxCost(int level) {
        return this.getMinCost(level) + TBZServerConfig.PROTECTIVE_WEAVE_ENCHANTABILITY_SPAN.get();
    }

    /** 最大附魔等级 **/
    @Override
    public int getMaxLevel() {
        return TBZServerConfig.PROTECTIVE_WEAVE_MAX_LEVEL.get();
    }
