...
public class TouchOfMaliceEnchantment extends Enchantment {
    ...
    public int getMinCost(int level) {
        return TBZServerConfig.TOUCH_OF_MALICE_BASE_ENCHANTABILITY.get() + (level - 1) * TBZServerConfig.TOUCH_OF_MALICE_LEVEL_ENCHANTABILITY.get();
    }

    /** 最大附魔成本 **/
    @Override
    public int getMaxCost(int level) {
        return this.getMinCost(level) + TBZServerConfig.TOUCH_OF_MALICE_ENCHANTABILITY_SPAN.get();
    }

    /** 最大附魔等级 **/
    @Override
    public int getMaxLevel() {
        return TBZServerConfig.TOUCH_OF_MALICE_MAX_LEVEL.get();
    }
