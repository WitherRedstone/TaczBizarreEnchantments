...
public interface TBZEnchantments {
    ...
    RegistryObject<GutshotStraightEnchantment> GUTSHOT_STRAIGHT = ENCHANTMENTS.register("gutshot_straight",
            () -> new GutshotStraightEnchantment(Enchantment.Rarity.UNCOMMON, DESTINY_GUN, new EquipmentSlot[]{EquipmentSlot.MAINHAND}));
    /** 热能雾化 **/
    RegistryObject<ThermalAtomizationEnchantment> THERMAL_ATOMIZATION = ENCHANTMENTS.register("thermal_atomization",
            () -> new ThermalAtomizationEnchantment(Enchantment.Rarity.VERY_RARE, DESTINY_GUN, new EquipmentSlot[]{EquipmentSlot.MAINHAND}));
    /** 斗剑士 **/
    RegistryObject<SwashbucklerEnchantment> SWASHBUCKLER = ENCHANTMENTS.register("swashbuckler",
            () -> new SwashbucklerEnchantment(Enchantment.Rarity.UNCOMMON, DESTINY_GUN, new EquipmentSlot[]{EquipmentSlot.MAINHAND}));
    /** 我为人人 **/
    ...
    RegistryObject<FiringLineEnchantment> FIRING_LINE_CHARGE = ENCHANTMENTS.register("firing_line",
            () -> new FiringLineEnchantment(Enchantment.Rarity.VERY_RARE, DESTINY_GUN, new EquipmentSlot[]{EquipmentSlot.MAINHAND}));
    /** 盒式呼吸法 **/
    RegistryObject<BoxBreathingEnchantment> BOX_BREATHING = ENCHANTMENTS.register("box_breathing",
            () -> new BoxBreathingEnchantment(Enchantment.Rarity.VERY_RARE, DESTINY_GUN, new EquipmentSlot[]{EquipmentSlot.MAINHAND}));
    /** 爆炸光能 **/
    ...
    RegistryObject<SubsistenceEnchantment> SUBSISTENCE = ENCHANTMENTS.register("subsistence",
            () -> new SubsistenceEnchantment(Enchantment.Rarity.UNCOMMON, DESTINY_GUN, new EquipmentSlot[]{EquipmentSlot.MAINHAND}));
    /** 刺客野心 **/
    RegistryObject<AmbitiousAssassinEnchantment> AMBITIOUS_ASSASSIN = ENCHANTMENTS.register("ambitious_assassin",
            () -> new AmbitiousAssassinEnchantment(Enchantment.Rarity.UNCOMMON, DESTINY_GUN, new EquipmentSlot[]{EquipmentSlot.MAINHAND}));
    /** 重建 **/
    RegistryObject<ReconstructionEnchantment> RECONSTRUCTION = ENCHANTMENTS.register("reconstruction",
            () -> new ReconstructionEnchantment(Enchantment.Rarity.VERY_RARE, DESTINY_GUN, new EquipmentSlot[]{EquipmentSlot.MAINHAND}));
    /** 精准连击 **/
    ...
    RegistryObject<MulliganEnchantment> MULLIGAN = ENCHANTMENTS.register("mulligan",
            () -> new MulliganEnchantment(Enchantment.Rarity.UNCOMMON, DESTINY_GUN, new EquipmentSlot[]{EquipmentSlot.MAINHAND}));
    /** 涓流充能 **/
    ...
    RegistryObject<ReversalOfFortuneEnchantment> REVERSAL_OF_FORTUNE = ENCHANTMENTS.register("reversal_of_fortune",
            () -> new ReversalOfFortuneEnchantment(Enchantment.Rarity.RARE, DESTINY_GUN, new EquipmentSlot[]{EquipmentSlot.MAINHAND}));
    /** 小丑皇弹药筒 **/
    RegistryObject<ClownCartridgeEnchantment> CLOWN_CARTRIDGE = ENCHANTMENTS.register("clown_cartridge",
            () -> new ClownCartridgeEnchantment(Enchantment.Rarity.VERY_RARE, DESTINY_GUN, new EquipmentSlot[]{EquipmentSlot.MAINHAND}));
    ...
    RegistryObject<RimestealerEnchantment> RIMESTEALER = ENCHANTMENTS.register("rimestealer",
            () -> new RimestealerEnchantment(Enchantment.Rarity.RARE, DESTINY_GUN, new EquipmentSlot[]{EquipmentSlot.MAINHAND}));
    /** 切割 **/
    ...
    RegistryObject<WitheringGazeEnchantment> WITHERING_GAZE = ENCHANTMENTS.register("withering_gaze",
            () -> new WitheringGazeEnchantment(Enchantment.Rarity.RARE, DESTINY_GUN, new EquipmentSlot[]{EquipmentSlot.MAINHAND}));
    /** 燃烧野心 **/
    RegistryObject<BurningAmbitionEnchantment> BURNING_AMBITION = ENCHANTMENTS.register("burning_ambition",
            () -> new BurningAmbitionEnchantment(Enchantment.Rarity.RARE, DESTINY_GUN, new EquipmentSlot[]{EquipmentSlot.MAINHAND}));
    ...
    RegistryObject<ExplosivePayloadEnchantment> EXPLOSIVE_PAYLOAD = ENCHANTMENTS.register("explosive_payload",
            () -> new ExplosivePayloadEnchantment(Enchantment.Rarity.VERY_RARE, DESTINY_GUN, new EquipmentSlot[]{EquipmentSlot.MAINHAND}));
    /** 萤火虫 **/
    ...
    RegistryObject<SnapshotSightsEnchantment> SNAPSHOT_SIGHTS = ENCHANTMENTS.register("snapshot_sights",
            () -> new SnapshotSightsEnchantment(Enchantment.Rarity.UNCOMMON, DESTINY_GUN, new EquipmentSlot[]{EquipmentSlot.MAINHAND}));
    /** 稳若磐石 **/
    ...
    RegistryObject<AdagioEnchantment> ADAGIO = ENCHANTMENTS.register("adagio",
            () -> new AdagioEnchantment(Enchantment.Rarity.VERY_RARE, DESTINY_GUN, new EquipmentSlot[]{EquipmentSlot.MAINHAND}));
    /** 猛攻 **/
    RegistryObject<OnslaughtEnchantment> ONSLAUGHT = ENCHANTMENTS.register("onslaught",
            () -> new OnslaughtEnchantment(Enchantment.Rarity.VERY_RARE, DESTINY_GUN, new EquipmentSlot[]{EquipmentSlot.MAINHAND}));
    /** 风暴之眼 **/
    ...
    RegistryObject<ShootTpLootEnchantment> SHOOT_TP_LOOT = ENCHANTMENTS.register("shoot_tp_loot",
            () -> new ShootTpLootEnchantment(Enchantment.Rarity.UNCOMMON, DESTINY_GUN, new EquipmentSlot[]{EquipmentSlot.MAINHAND}));
